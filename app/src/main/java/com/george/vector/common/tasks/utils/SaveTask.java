...
public class SaveTask implements TaskBehavior{
            ...
            switch (status){
                case "Новая заявка":
                    save("ost_school_new", name_task, address,
                            ...
                            time_create, email, urgent, image);
                    break;
                case "В работе":
    ...
    void save(String collection, String name_task, String address, String date_create,
              ...
              String status, String time_create, String email, boolean urgent, String image) {
        ...
        taskRef.add(new TaskUi(name_task, address, date_create, floor, cabinet, letter, comment, date_complete,
                executor, status, time_create, email, urgent, image));
